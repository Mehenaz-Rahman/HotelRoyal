                    ...
                    <div class="col-lg-12">
                        <div class="hero-content text-center">
                            ...
                            <div class="hero-button">
                                <a href="<?php echo e(url('restaurant')); ?>#reservation">Book A Table <i
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6  upper">
                    <div class="section-title">
                        ...
                        <div class="hero-button">
                            <a href="<?php echo e(url('restaurant')); ?>#menu">Expore Our Restaurant<i
                                    class="fi fi-ts-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="offer-details">
                            ...
                            <div class="offer-button">
                                <a href="<?php echo e(url('restaurant')); ?>#menu">Oder Now<i class="fi fi-ts-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="tab-content food-style" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                                ...
                                <div class="row">
                                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($data->category == 'Main Dishes'): ?>
                                            <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                                <div class="food-menu-style">
                                                    <div class="thumb">
                                                        <img src="<?php echo e(asset('menu/' . $data->image)); ?>" alt="<?php echo e($data->name); ?>">
                                                        <div class="d-flex">
                                                            <div class="food-review">
                                                                <i class="fas fa-star"></i>
                                                                <span><?php echo e($data->review); ?></span>
                                                            </div>
                                                            <div class="price">
                                                                <span><del>$<?php echo e($data->original_price); ?></del>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <ul>
                                                            <?php $__currentLoopData = explode(',', $data->ingredients); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="nav-beverages">
                                <div class="row">
                                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($data->category == 'Beverages'): ?>
                                            <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                                                <div class="food-menu-style">
                                                    <div class="thumb">
                                                        <img src="<?php echo e(asset('menu/' . $data->image)); ?>" alt="<?php echo e($data->name); ?>">
                                ...
                                <div class="swiper-slide">
                                    <div class="gallery-item position-relative">
                                        ...
                                        <div
                                            ...
                                            <span><?php echo e($food_gallery->food_description); ?></span>
                                            <h4><?php echo e($food_gallery->food_title); ?></h4>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
